...
alinhamento = AlignIO.read("especies.aln", "clustal")
...
Phylo.write(especiesTree, "especiesTree.xml", "phyloxml")
...
print("ARVORE DND")
tree_dnd = Phylo.read("especies.dnd", "newick")
